// Appended INSIDE the actual game's script by castle_simulator_58.mjs.
...
return { run: simRun, checks: simChecks, arrowChecks: simArrowChecks, inspect: () => ({ targetSizes: targetImgs.map((_, i) => placementSpriteSize(i)), physicsStep: PHYS_STEP, profiles: CastleBotUnderTest.profiles }) };

'use strict';
/* Bar Game 3.94 unified dialogue UI.
...
(function(){
 ...
 function beginTyping(){
   ...
   el.onkeydown=e=>{if(e.key!=='Enter')return;e.preventDefault();let raw=el.textContent||'',p=n+':';raw=raw.startsWith(p)?raw.slice(p.length).trim():raw.trim();
     el.contentEditable='false';el.onkeydown=null;typing=false;d.classList.remove('typing');if(controls)controls.style.display='';submit(raw,{silent:true})}
 }

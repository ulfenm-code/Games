...
function renderStep(newStep=false){
  ...
  if(isMojitoV318()&&s?.auto){state.step++;state.lastRecipeQuestion='';if(typeof renderStep==='function')return renderStep(true);return}

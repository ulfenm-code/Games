...
{q:'Vilken bassprit börjar vi med?',a:'Vit rom',opts:['Vit rom','Gin','Tequila'],amount:{base:4,unit:'cl',label:'vit rom'}},
{q:'Vilken citrus ska i?',a:'Lime',opts:['Lime','Citron','Apelsin'],amount:{base:2,unit:'cl',label:'limejuice'}},
{q:'Vilken ört hör hemma i en Mojito?',a:'Mynta',opts:['Mynta','Basilika','Rosmarin'],amount:{base:8,unit:'blad',label:'mynta'}},
{q:'Vad använder vi för sötma?',a:'Socker',opts:['Socker','Salt','Kaffe'],amount:{base:2,unit:'tsk',label:'socker'}},
...
{q:'Vad toppar vi med?',a:'Sodavatten',opts:['Sodavatten','Mjölk','Cola'],amount:{base:4,unit:'cl',label:'sodavatten'}},

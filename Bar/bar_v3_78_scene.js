...
(function(){
  ...
  function applyPreparedConfig(cfg,prepared,{url=null,showGlass=null,generation=0}={}){
    ...
    window.__barActiveConfig378=cfg;
    window.__barActiveGlassSystem378=cfg.glassSystem||null;
  ...
  async function loadAndApply(url,options={}){
    ...
    try{
      ...
      if(generation===activationGeneration){
        ...
        console.error('Bar v3.78 scene config:',err);
        reveal();
      }
      throw err;
    }
  ...
  const api=window.__barSceneConfig378={
    startUrl:START_URL,
    loadConfig,
    loadAndApply,
    activeConfig:null,

...
(function(){
  ...
  function liquidHeight(){
    if(visual.soda)return 91;
    if(visual.rum)return 83;
    if(visual.ice)return 76;
    if(visual.littleSoda)return 58;
    if(visual.limeSugar)return 52;
    if(visual.mint)return 36;
    return 0;
  }

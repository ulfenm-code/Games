'use strict';
/* Bar Game 3.5 unified dialogue UI.
...
(function(){
 ...
 function makeControls(){
   ...
   if(!row){row=document.createElement('div');row.className='v31Controls';q('#barScene')?.appendChild(row);row.innerHTML='<button class="btn secondary" id="v31MicBtn" title="Mikrofon">🎙️</button><button class="btn" id="v31KeyboardBtn" title="Tangentbord">Tangentbord</button><button class="btn secondary" id="v31PrintBtn" title="Utskrift">Utskrift</button>';c.prepend(row)}

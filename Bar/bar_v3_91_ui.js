'use strict';
/* Bar Game 3.91 unified dialogue UI.
...
(function(){
 ...
 function submit(raw){
   ...
   add(player(),raw);
   if(state.phase==='recipe'&&typeof handleRecipeInput==='function')handleRecipeInput(raw,{silent:true});
   else if(typeof handleConversation==='function')handleConversation(raw,{silent:true})
 }

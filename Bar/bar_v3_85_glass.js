...
(function(){
  ...
  const HIGHBALL_CONFIG_URL='./bartender_installningar_higballglas6.json';
  const GARNISH_CONFIG_URL='./bartender_installningar_mojitogarnering5.json';
  ...
  const sceneConfig=window.__barSceneConfig385;
  const ready=Promise.all([
    ...
    if(!highballCfg?.objects?.highballGlass)throw new Error('Higballglas6 saknar objects.highballGlass');
    ...
    console.error('Bar v3.85 glass system:',err);
    throw err;
  });
